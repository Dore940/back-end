...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Lucie.Wilkinson93',
      password: 'zEI_YmZfevGcIXe',
      email: 'Nicholas62@gmail.com',
      name: 'Ruben Lindgren',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 161,
      mobileNo: '(272) 716-3754',
      resetPasswordLink: {},
      loginRetryLimit: 981,
      loginReactiveTime: '2022-10-25T07:19:47.824Z',
      id: '62ff70abb304ad8ebcaba6d8'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Nellie.Halvorson',
        'password':'PF5HEt68OsHJj0J',
        'email':'Norval.Satterfield46@gmail.com',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Norval.Satterfield46@gmail.com', });
