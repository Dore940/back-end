...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Shana.Larson',
      password: 'qJFfUBXCcIHQJUu',
      email: 'Jacklyn.Hilll92@yahoo.com',
      name: 'Vicky Stark',
      shippingAddress: [
        {
          _id: false,
          pincode: 'Sausages',
          address1: 'Multi-tiered',
          address2: 'Cotton',
          landmark: 'Swaziland',
          city: 'Chips',
          isDefault: false,
      ...
      userType: 92,
      mobileNo: '(249) 530-0043',
      resetPasswordLink: {},
      loginRetryLimit: 604,
      loginReactiveTime: '2022-09-15T10:22:50.619Z',
      id: '62ff70abb304ad8ebcaba66c'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Adah.Runolfsdottir',
        'password':'Ck7RV33vcC6FaCU',
        'email':'Nichole.Stanton@yahoo.com',
        'name':'Sonja Bradtke',
        'shippingAddress':[{
          '_id':false,
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Nichole.Stanton@yahoo.com', });
